const seed = {
  ...
  productStyles: [
    ...
    },
    {
      ...
      vendor_description:
        'Sport-Tek® Sport-Wick® Stretch Reflective Heather 1/2-Zip Pullover Jacket ST855',
    },
    {
      product_brand_id: 3,
      style_name: '50/50 Cotton/ Poly T-Shirt',
      vendor_description:
        'PC55P ATHLETIC HEATHER Port & Company® 50/50 Cotton/ Poly T-Shirt with Pocket',
    },
  ],
  sizes: [
    {
