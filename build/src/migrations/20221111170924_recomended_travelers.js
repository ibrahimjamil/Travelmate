...
function up(knex) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            ...
            return [2 /*return*/, knex.schema.createTable('recommended_travelers', function (t) {
                    t.increments('id');
                    t.string('name');
                    t.string('email');
                    t.string('rating');
...
function down(knex) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, knex.schema.dropTable('recommended_travelers')];
        });
    });
}
exports.down = down;
//# sourceMappingURL=20221111170924_recomended_travelers.js.map